...
function Oracle (init) {
  ...
  if (this['@data'].resources) {
    console.log('init resources:', init.resources);
  }

  // TODO: transform streams
  this.broadcaster = new stream.Writable({
...
Oracle.prototype._GET = async function (key, params) {
  console.log('[ORACLE]', '[GET]', '[REQUEST]', key, params || 'list?');
  return await this.storage.get(key);
};

Oracle.prototype._PUT = async function (key, obj) {
  console.log('[ORACLE]', '[PUT]', '[REQUEST]', key, obj);
...
Oracle.prototype._POST = async function (key, obj) {
  ...
  console.log('[ORACLE]', '[POST]', '[REQUEST]', key, obj, collection);
